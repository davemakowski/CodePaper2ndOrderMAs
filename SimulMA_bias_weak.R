###Function to generate datasets with a bias of type 1


SimulMA_bias_weak<-function(NumMA,NumS,Prop,MU,K2, Seed) {
...
nameTAB=paste("PubBiasWeak", NumMA,NumS,Prop,MU,K2, ".txt")
