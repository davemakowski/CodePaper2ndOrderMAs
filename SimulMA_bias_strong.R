#Function used to generate datasets with a bias of type 2

SimulMA_bias_strong<-function(NumMA,NumS,Prop,MU,K2, Seed) {
...
nameTAB=paste("PubBiasStrong", NumMA,NumS,Prop,MU,K2, ".txt")
