##Function used to generate datasets (without bias)


SimulMA2<-function(NumMA,NumS,Prop,MU,K2, Seed) {
...
Theta_o=rnorm(NumS_o, MU, Sigma_b)
Sigma_e_o=runif(NumS_o, Sigma_e_min, Sigma_e_max)
Y_o=rnorm(NumS_o,Theta_o,Sigma_e_o)
...
nameTAB=paste("Sim", NumMA,NumS,Prop,MU,K2, ".txt")
